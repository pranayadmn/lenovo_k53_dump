...
if [ $SAVEFLAG = TRUE ]; then
	...
	cd $APLOG_DIR  && rm -fr lastkmsg lastlog gps anr recovery tombstones bluetooth wlan dropbox bootloader simlock
    ...
    [ -d $SIMLOCKLOG ] && cp -a $SIMLOCKLOG $APLOG_DIR/simlock
